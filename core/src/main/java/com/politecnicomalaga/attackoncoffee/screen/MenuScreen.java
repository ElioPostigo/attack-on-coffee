    ...
    public class MenuScreen extends ScreenAdapter {
        ...
        @Override
        public void show() {
            background = new Texture("FondoMenuInicio.jpg");
            startButton = new Texture("StartAttackOnCoffee.png");
            titleTexture = new Texture("titulo.png");
        ...
        public void render(float delta) {
            ...
            float titleWidth = 700;
            float titleHeight = 180;

            float titleX =
                (SettingsManager.SCREEN_WIDTH / 2f)
                    - (titleWidth / 2f);
